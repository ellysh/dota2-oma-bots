...
local OBJECTIVES = {
  ...
  [2] = {
    ...
    moves = {
      {move = "lasthit_enemy_creep", desire = 90},
      {move = "deny_ally_creep", desire = 80},
      {move = "harras_enemy_hero", desire = 70},
      {move = "evasion", desire = 60},
      {move = "move_mid_front_lane", desire = 50},
